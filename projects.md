...
<div class="project-item">
  ...
  <p class="project-description">Evaluating computational frameworks to predict how mutations impact protein stability and interaction affinity using large-scale experimental datasets.</p>
...
<div class="project-item">
  ...
  <p class="project-description">Developing machine learning solutions to identify polyadenylation tail regions in raw RNA sequencing signals from Oxford Nanopore Technologies.</p>
...
<div class="project-item">
  ...
  <p class="project-description">Investigating the temporal dynamics of genomic regions with reduced diversity through population genetics simulations.</p>
